...
<div class="popup thing-detail no-end-days" style="display:none;">
    ...
    <!-- smaller thumbnail pictures -->
		<div class="figure-list-wrapper">
			...
			<?php
      //create thumbnails for product pictures
      //clicking on thumbnail loads picture into larger viewer
    ...
    <!-- arrows to toggle thumbnail pictures -->
  ...
  <!-- container that displays zoomed in pictures -->
  ...
  <!-- container for product info -->
    ...
    <!-- doesn't appear in product preview box?? -->
    <div class="quick-shipping" sii="57397" style="padding-top:0;">
      <span class="icon truck"></span>
        <?php
          if($this->lang->line('header_immed_ship') != '') {
            echo stripslashes($this->lang->line('header_immed_ship'));
          } else echo "Immediate Shipping";
        ?>
          <span class="tooltip"><i class="icon"></i> <small><?php if($this->lang->line('header_ship_within') != '') { echo stripslashes($this->lang->line('header_ship_within')); } else echo "Ships within 1-3 business days"; ?><b></b></small></span>
    </div>
