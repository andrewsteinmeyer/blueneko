...
class Cart_model extends My_Model
{
	...
	public function mani_cart_view($userid=''){
		...
		if($shipVal -> num_rows() >0 ){
			//already queried for address above, could we not just have queried for 'primary' => 'Yes' above?
		...
		//think this is for a monthly subscription
		...
		//all of these values are already returned from database in query above
		//why query for them again?  Seems inefficient.
