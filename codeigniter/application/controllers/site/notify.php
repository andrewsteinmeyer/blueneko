...
class Notify extends MY_Controller {
  ...
  public function getlatest(){
    ...
    //check login
      ...
      //notifications in userDetails are not actual notifictions
      ...
      //this could be much better
        ...
        //then add the product_id to array
        ...
        //query for products sold by this user
        ...
        //grab the product id's and collect in respective array
        ...
        //store all of these product_id's in $activityArr and also add the fc_session_user_id
          ...
          //then iterate over each one and build the notifications list
            ...
            //iterate over each relevant notification
              ...
              //load the image for the user that generated the activity
                ...
                //this user will see it in notifications even before they have approved it b/c it is they are selling the product
